...
I have used the oled display with the [[https://github.com/adafruit/Adafruit_SSD1306][Adafruit_SSD1306]] library. I want to try out ESPIDF and had a oled display lying around. Lets get to it without boring you.
...
You can find the documentation of I2C for espidf for [[https://docs.espressif.com/projects/esp-idf/en/v5.1.2/esp32/api-reference/peripherals/i2c.html?highlight=i2c][here]]. 
...
* Intialization
[[./ssd1306-block-diagram.png][block-diagram]]
...
You can find the documentation of function used from espIDF official [[https://docs.espressif.com/projects/esp-idf/en/v5.1.2/esp32/api-reference/peripherals/i2c.html?highlight=i2c][documenation]].
